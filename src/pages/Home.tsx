          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 max-w-6xl mx-auto">
            {[
              ...
              <Link
                ...
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <div className="bg-white/10 backdrop-blur-md hover:bg-white/20 rounded-2xl p-4 text-center transition-all duration-300 hover:scale-105 hover:shadow-2xl border border-white/20 group cursor-pointer">
                  <div className="text-4xl sm:text-5xl mb-3 group-hover:scale-110 transition-transform">
                    {game.icon}
                  </div>
                  <div className="text-white font-bold text-sm sm:text-base mb-2">{game.name}</div>
                  {game.coins > 0 && (
