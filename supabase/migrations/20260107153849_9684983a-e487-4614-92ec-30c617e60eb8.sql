-- Create a secure function for users to earn points for valid actions
-- This replaces client-side calls to award_points (which is now admin-only)
-- Each action type has a fixed point value to prevent manipulation
