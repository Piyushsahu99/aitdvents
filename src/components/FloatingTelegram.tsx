        ...
        <div className="p-4 space-y-3">
          ...
          <div className="space-y-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full flex items-center justify-center gap-2 bg-[#0088cc] hover:bg-[#0077b5] text-white font-medium py-2.5 px-4 rounded-lg transition-colors"
            >
          ...
          <button
            ...
            className="w-full px-3 py-2 text-sm text-muted-foreground hover:text-foreground border border-border rounded-lg transition-colors"
          >
            Maybe Later
          </button>
        </div>
